...
public class VentilatorPanelTest {
    ...
    public VentilatorPanelTest() {
         ...
         AppTest.connectButton.setEnabled(false);  // Disabilitato finché la simulazione non parte
         AppTest.connectButton.setForeground(Color.BLACK);
         AppTest.connectButton.setFocusPainted(false);
         ...
         buttonPanel.add(AppTest.connectButton);
         ...
         AppTest.connectButton.addActionListener(e -> {
